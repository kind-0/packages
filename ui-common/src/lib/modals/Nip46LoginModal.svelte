                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <Textarea
                            ...
                            class="input input-bordered resize-none font-mono text-sm rounded-b-none"
                            placeholder='Enter connection string'
                        />

                        <AttentionButton class="btn text-lg" on:click={login}>
